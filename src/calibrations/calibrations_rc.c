	...
	if(!_calibrations.data.rc.waiting) {
		switch( _calibrations.data.rc.step ) {
			...
			case CAL_RC_RANGE_MIDDOWN: {
				...
				set_param_uint( PARAM_RC1_MID, _calibrations.data.rc.ranges[0][SENSOR_RC_CAL_MID]);
				set_param_uint( PARAM_RC2_MID, _calibrations.data.rc.ranges[1][SENSOR_RC_CAL_MID]);
				set_param_uint( PARAM_RC3_MID, _calibrations.data.rc.ranges[2][SENSOR_RC_CAL_MID]);
				set_param_uint( PARAM_RC4_MID, _calibrations.data.rc.ranges[3][SENSOR_RC_CAL_MID]);
				set_param_uint( PARAM_RC5_MID, _calibrations.data.rc.ranges[4][SENSOR_RC_CAL_MID]);
				set_param_uint( PARAM_RC6_MID, _calibrations.data.rc.ranges[5][SENSOR_RC_CAL_MID]);
				set_param_uint( PARAM_RC7_MID, _calibrations.data.rc.ranges[6][SENSOR_RC_CAL_MID]);
				set_param_uint( PARAM_RC8_MID, _calibrations.data.rc.ranges[7][SENSOR_RC_CAL_MID]);
			...
			case CAL_RC_RANGE_DONE: {
				...
				set_param_uint( PARAM_RC1_MIN, _calibrations.data.rc.ranges[0][SENSOR_RC_CAL_MIN]);
				set_param_uint( PARAM_RC1_MAX, _calibrations.data.rc.ranges[0][SENSOR_RC_CAL_MAX]);
				set_param_uint( PARAM_RC2_MIN, _calibrations.data.rc.ranges[1][SENSOR_RC_CAL_MIN]);
				set_param_uint( PARAM_RC2_MAX, _calibrations.data.rc.ranges[1][SENSOR_RC_CAL_MAX]);
				set_param_uint( PARAM_RC3_MIN, _calibrations.data.rc.ranges[2][SENSOR_RC_CAL_MIN]);
				set_param_uint( PARAM_RC3_MAX, _calibrations.data.rc.ranges[2][SENSOR_RC_CAL_MAX]);
				set_param_uint( PARAM_RC4_MIN, _calibrations.data.rc.ranges[3][SENSOR_RC_CAL_MIN]);
				set_param_uint( PARAM_RC4_MAX, _calibrations.data.rc.ranges[3][SENSOR_RC_CAL_MAX]);
				set_param_uint( PARAM_RC5_MIN, _calibrations.data.rc.ranges[4][SENSOR_RC_CAL_MIN]);
				set_param_uint( PARAM_RC5_MAX, _calibrations.data.rc.ranges[4][SENSOR_RC_CAL_MAX]);
				set_param_uint( PARAM_RC6_MIN, _calibrations.data.rc.ranges[5][SENSOR_RC_CAL_MIN]);
				set_param_uint( PARAM_RC6_MAX, _calibrations.data.rc.ranges[5][SENSOR_RC_CAL_MAX]);
				set_param_uint( PARAM_RC7_MIN, _calibrations.data.rc.ranges[6][SENSOR_RC_CAL_MIN]);
				set_param_uint( PARAM_RC7_MAX, _calibrations.data.rc.ranges[6][SENSOR_RC_CAL_MAX]);
				set_param_uint( PARAM_RC8_MIN, _calibrations.data.rc.ranges[7][SENSOR_RC_CAL_MIN]);
				set_param_uint( PARAM_RC8_MAX, _calibrations.data.rc.ranges[7][SENSOR_RC_CAL_MAX]);
		...
		if(_calibrations.data.rc.waiting) {
			...
			mavlink_prepare_command_ack(&msg,
										...
										_calibrations.req_sysid,
										_calibrations.req_compid,
