...
static mavlink_stream_t mavlink_stream_comm_0[MAVLINK_STREAM_COUNT] = {
	{.param_rate = PARAM_STREAM_RATE_HEARTBEAT_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_heartbeat},
	{.param_rate = PARAM_STREAM_RATE_STATUS_IO_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_status_io},
	{.param_rate = PARAM_STREAM_RATE_SYS_STATUS_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_sys_status},
	{.param_rate = PARAM_STREAM_RATE_HIGHRES_IMU_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_highres_imu},
	{.param_rate = PARAM_STREAM_RATE_ATTITUDE_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_attitude},
	{.param_rate = PARAM_STREAM_RATE_ATTITUDE_QUATERNION_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_attitude_quaternion},
	{.param_rate = PARAM_STREAM_RATE_ATTITUDE_TARGET_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_attitude_target},
	{.param_rate = PARAM_STREAM_RATE_RC_CHANNELS_RAW_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_rc_channels_raw},
	{.param_rate = PARAM_STREAM_RATE_SERVO_OUTPUT_RAW_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_servo_output_raw},
	{.param_rate = PARAM_STREAM_RATE_TIMESYNC_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_timesync},
	{.param_rate = PARAM_STREAM_RATE_BATTERY_STATUS_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_battery_status},
	{.param_rate = PARAM_STREAM_RATE_LOW_PRIORITY_0,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_low_priority}};

static mavlink_stream_t mavlink_stream_comm_1[MAVLINK_STREAM_COUNT] = {
	{.param_rate = PARAM_STREAM_RATE_HEARTBEAT_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_heartbeat},
	{.param_rate = PARAM_STREAM_RATE_STATUS_IO_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_status_io},
	{.param_rate = PARAM_STREAM_RATE_SYS_STATUS_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_sys_status},
	{.param_rate = PARAM_STREAM_RATE_HIGHRES_IMU_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_highres_imu},
	{.param_rate = PARAM_STREAM_RATE_ATTITUDE_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_attitude},
	{.param_rate = PARAM_STREAM_RATE_ATTITUDE_QUATERNION_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_attitude_quaternion},
	{.param_rate = PARAM_STREAM_RATE_ATTITUDE_TARGET_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_attitude_target},
	{.param_rate = PARAM_STREAM_RATE_RC_CHANNELS_RAW_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_rc_channels_raw},
	{.param_rate = PARAM_STREAM_RATE_SERVO_OUTPUT_RAW_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_servo_output_raw},
	{.param_rate = PARAM_STREAM_RATE_TIMESYNC_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_timesync},
	{.param_rate = PARAM_STREAM_RATE_BATTERY_STATUS_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_battery_status},
	{.param_rate = PARAM_STREAM_RATE_LOW_PRIORITY_1,
	 .period_update = 0,
	 .last_time_us = 0,
	 .send_function = mavlink_stream_low_priority}};
...
static bool transmit_stream( uint32_t time_us, uint8_t port,
							 mavlink_stream_t* stream ) {
