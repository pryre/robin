...
RC_PPM_PULSE_T | uint | Sets the PPM pulse input mode to positive/pulldown (1,true) or negitive/pullup (0,false) for supported boards | 1 | 0 / 1 | boolean | True
RC_PPM_DATA_MIN | uint | Sets the minimum data PPM pulse that will be accepted | 800 |  | scalar | False
RC_PPM_DATA_MAX | uint | Sets the maximum data PPM pulse that will be accepted | 2200 |  | scalar | False
RC_PPM_SYNC_MIN | uint | Sets the minimum pulse that will be interpreted as a PPM sync | 2700 |  | scalar | False
RC_PPM_SYNC_MAX | uint | Sets the maximum pulse that will be interpreted as a PPM sync | 30000 |  | scalar | False
