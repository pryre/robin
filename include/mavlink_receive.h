...
void mavlink_handle_command_long( mavlink_channel_t chan, mavlink_message_t* msg,
								  mavlink_status_t* status );
void mavlink_handle_mission_request_list( mavlink_channel_t chan,
										  mavlink_message_t* msg,
										  mavlink_status_t* status );
...
void mavlink_handle_set_attitude_target( mavlink_channel_t chan,
										 mavlink_message_t* msg,
										 mavlink_status_t* status );
void mavlink_handle_set_mode( mavlink_channel_t chan, mavlink_message_t* msg,
							  mavlink_status_t* status );
...
MAV_RESULT mavlink_handle_command_long_do_motor_test( mavlink_channel_t chan,
													  float* params );
MAV_RESULT
mavlink_handle_command_long_request_protocol_version( mavlink_channel_t chan,
													  float* params );
MAV_RESULT mavlink_handle_command_long_request_autopilot_capabilities(
	mavlink_channel_t chan, float* params );
MAV_RESULT mavlink_handle_command_long_get_home_position( mavlink_channel_t chan,
														  float* params );
MAV_RESULT mavlink_handle_command_long_preflight_storage( mavlink_channel_t chan,
														  float* params );
MAV_RESULT mavlink_handle_command_long_reboot_shutdown( mavlink_channel_t chan,
														float* params,
														uint8_t sysid,
														uint8_t compid );
MAV_RESULT
