...
FW_VERSION | uint | A compile-time stamp for the flight firmware version |  |  | None | False
SW_VERSION | uint | A compile-time stamp for the OS firmware version |  |  | None | False
