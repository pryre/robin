...
void set_param_defaults(void) {
	...
	init_param_uint(PARAM_EST_USE_MAT_EXP, "EST_ACC_COR", 1);
	init_param_uint(PARAM_EST_USE_QUAD_INT, "EST_ACC_COR", 1);
	...
	init_param_fix16(PARAM_ACC_X_SCALE_NEG, "ACC_X_S_POS", fix16_from_float(1.0f));
	init_param_fix16(PARAM_ACC_Y_SCALE_POS, "ACC_Y_S_POS", fix16_from_float(1.0f));
	init_param_fix16(PARAM_ACC_Y_SCALE_NEG, "ACC_Y_S_POS", fix16_from_float(1.0f));
	init_param_fix16(PARAM_ACC_Z_SCALE_POS, "ACC_Z_S_POS", fix16_from_float(1.0f));
	init_param_fix16(PARAM_ACC_Z_SCALE_NEG, "ACC_Z_S_POS", fix16_from_float(1.0f));
	...
	init_param_fix16(PARAM_MAX_ROLL_ANGLE, "PID_ROLL_ANG_P", fix16_from_float(0.786f));
	init_param_fix16(PARAM_PID_PITCH_ANGLE_P, "PID_PITCH_ANG_P", fix16_from_float(6.5f));
	init_param_fix16(PARAM_MAX_PITCH_ANGLE, "PID_PITCH_ANG_P", fix16_from_float(0.786f));
	init_param_fix16(PARAM_PID_YAW_ANGLE_P, "PID_PITCH_ANG_P", fix16_from_float(6.5f));
